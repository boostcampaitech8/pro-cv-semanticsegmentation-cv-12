...
<div align="center">
    <table border="1" cellspacing="0" cellpadding="8">
      ...
      <tbody>
        <tr>
          <td>김범진</td>
          <td>모델 실험, 결과 분석 및 방향 설정, Pseudo label, Class 별 Prediction 결과 분석</td>
        </tr>
        <tr>
          <td>김준수</td>
          <td>모델 설계, 실험 효율화, 모델 고도화</td>
        </tr>
        <tr>
          <td>김한준</td>
          <td>모델 설계 및 실험, 앙상블 전략 수립 및 실행</td>
        </tr>
        <tr>
          <td>남현지</td>
          <td>Train Data EDA, 모델 설계 및 실험, Prediction Analysis, 앙상블 전략 설계</td>
        </tr>
        <tr>
          <td>송예림</td>
          <td>모델 설계 및 실험, Prediction Analysis, 앙상블 전략 설계</td>
        </tr>
      </tbody>
    </table>
</div>  
...
### 랩업리포트 링크
<a href="https://drive.google.com/file/d/1NMZ-KfFSc8uEYm6ZXsKU-Eju13eTVnwR/view?usp=sharing">CV12-semanticsegmentaiton-wrap-up-report</a>
